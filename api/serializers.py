...
class _DaySerializer(serializers.ModelSerializer): 
    ...
    class Meta:                                 
        model = Day
        fields = ['name','created_date','id','owner']
...
class DailySerializer(serializers.ModelSerializer):
    ...
    created_date = serializers.DateField(required=False, read_only=False, )
    text = serializers.CharField(required=False, allow_blank=True, max_length=5000, trim_whitespace=False)
    char1 = serializers.CharField(required=False, allow_blank=True, max_length=5000)
    char2 = serializers.CharField(required=False, allow_blank=True, max_length=5000)
    char3 = serializers.CharField(required=False, allow_blank=True, max_length=5000)
    class Meta:
        model = Daily
        fields = ['text','created_date','order','id','show','day','char1','char2','char3','int1','int2','int3','int4','int5','int6','bool1','bool2','bool3','bool4','bool5','bool5','bool6']
    def update(self, instance, validated_data):
        ...
        return instance
    def create(self, validated_data):
        order = len(Daily.objects.filter(day=validated_data.get('day')))
...
class UserSerializer(serializers.ModelSerializer):
    ...
    mindsets = _MindsetSerializer(many=True, required=False)
    days = _DaySerializer(many=True, required=False)
    class Meta:
        model = User
        fields = ['username','id','email','reminders','mindsets','days']
